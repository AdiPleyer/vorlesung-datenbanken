...
--- employees and their salaries including bonus
SELECT EEID, FullName, AnnualSalary as BaseSalary, BonusPercent,
		AnnualSalary * BonusPercent / 100 AS BonusAmount,
		AnnualSalary * (1 + BonusPercent / 100) AS TotalSalary
	FROM employees
